...
image4 = CurrentFolder+'\\box.png'
image5 = CurrentFolder+'\\niranjan.png'
...
wb = xl_copy(rb)
inp = input('you are the first person Please give todays date ')
